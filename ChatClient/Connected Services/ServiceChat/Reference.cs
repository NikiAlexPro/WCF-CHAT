...
namespace ChatClient.ServiceChat {
    ...
    public interface IServiceChat {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/Send_Message")]
        void Send_Message(string message, int id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/Send_Message")]
        System.Threading.Tasks.Task Send_MessageAsync(string message, int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceChatCallback {
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/Message_CallBack")]
    ...
    public partial class ServiceChatClient : System.ServiceModel.DuplexClientBase<ChatClient.ServiceChat.IServiceChat>, ChatClient.ServiceChat.IServiceChat {
        ...
        public void Send_Message(string message, int id) {
            base.Channel.Send_Message(message, id);
        }
        
        public System.Threading.Tasks.Task Send_MessageAsync(string message, int id) {
            return base.Channel.Send_MessageAsync(message, id);
        }
    }
}
